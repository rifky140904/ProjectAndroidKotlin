...
fun manipulateString(str: String, int: Int): String {
    ...
    val nonNumericPart = str.filter { !it.isDigit() }

    val result = if (numericPart != 0) {
        nonNumericPart + (numericPart * int)
    } else {
        nonNumericPart + int.toString()
    }
...
fun main() {
    ...
    println(manipulateString("dicoding", 99))
